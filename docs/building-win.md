# Build instructions for TeleForge on Windows
...
The default toolset in Visual Studio 2022 works with the current TeleForge setup used by this repository and CI.
